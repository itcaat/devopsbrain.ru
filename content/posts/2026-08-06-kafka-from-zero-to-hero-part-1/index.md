...
{{< callout type="tip" text="Kafka хранит committed offset не в памяти consumer-а, а во внутреннем топике __consumer_offsets. Важно понимать, что позиция чтения относится к конкретной связке Consumer Group, Topic и Partition, а не ко всей группе целиком." >}}
