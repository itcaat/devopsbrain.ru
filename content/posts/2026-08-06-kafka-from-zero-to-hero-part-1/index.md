...
Вы должно четко понимать, что любое усложнение и изменение архитектуры должно быть оправданным. Очень часто Kafka пытаются использовать абсолютно везде и это ошибка. 
