---
title: "Kafka: проектирование Topics, Keys и событий — Часть 7"
date: 2026-08-06T16:00:00+03:00
description: "Практический разбор проектирования Kafka до запуска в production: как выбирать Topics, Keys, количество Partition, Retention и формат событий."
tags: [kafka]
thumbnail: "images/image.png"
toc: true
series: "kafka-from-zero-to-hero"
tldr: "Production-дизайн Kafka начинается с модели данных: нужно определить тип сообщения, границы Topic, Key, количество Partition, Retention и контракт события."
---
